...
Documentation on the net module can be found by pointing your browser here:
  ...
  file:///home/lee/news/node-v0.10.26-linux-x64/lib/node_modules/learnyounode/node_apidoc/net.html
...
*/
    ...
    var min;
      // socket handling logic
        ...
        if (month < 10 ) var MM = '0' + month;
        var minutes = parseInt(date.getMinutes()); 
        minutes < 10 ? min = '0' + minutes : min = minutes;
        var customDate = date.getFullYear() + '-' + MM + '-' + date.getDate() + ' ' + date.getHours() + ':' + min; 
        socket.write(customDate +'\n');
        socket.end()
process.exit();
    })
